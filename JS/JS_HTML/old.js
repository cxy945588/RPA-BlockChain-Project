...
if (typeof window.ethereum !== 'undefined') {
    ...
    window.ethereum.enable().then(async function () {
        ...
        for (let i = 0; i < recordIndices.length; i++) {
            ...
            const date = new Date(record[5] * 1000).toLocaleString();
            ...
            resultDiv.innerHTML += `<div class='cd-timeline__block'>
                ...
                <div id='content1' class='cd-timeline__content text-component'>
                    ...
                    <div class='flex justify-between items-center'>
                        ...
                        <a id='downloadReportButton' class='btn btn--subtle'>產檢報告</a>
                        <a id='viewCertificateButton' class='btn btn--subtle' data-ipfs-cid='${record[3]}'>查看憑證</a>
                    </div>
